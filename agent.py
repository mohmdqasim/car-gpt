...
def generate_response(message_history):
    ...
    messages.insert(0, {
        "role": "system", 
        "content": """You are a helpful assistant named Car-GPT whose goal is to aid users with pharmaceutical car-related questions. 
...
def generate_stream(message_history):
    ...
    messages.insert(0, {
        "role": "system", 
        "content": """You are a helpful assistant named Car-GPT whose goal is to aid users with pharmaceutical car-related questions. If a user 
