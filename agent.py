...
def generate_response(message_history):
    ...
    messages.insert(0, {
        "role": "system", 
        "content": """You are a helpful assistant named Car-GPT whose goal is to aid users with any car-related questions. 
...
def generate_stream(message_history):
    messages = [{"role": m["role"], "content": m["pharmaceuticalcontent"]} for m in message_history]
    messages.insert(0, {
        "role": "system", 
